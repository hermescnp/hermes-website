    ...
    return (
        <div id="aboutContent" >
            ...
            <div className="biography-container">
                <p id="biography-text">With over 7 years of experience in UX/UI development, 3D modeling, and rendering, I specialize in technical art focused on virtual reality and artificial intelligence.
